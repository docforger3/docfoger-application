...
@Component({
      ...
      <div class="footer-inner container">
        <div class="footer-top">
          <div class="footer-brand">
            ...
            <p class="footer-desc">Your all-in-one document toolkit. Convert, design, calculate, split expenses, and manage loans — all from a single premium platform.</p>
          ...
          <div class="footer-links">
            ...
            <div class="footer-column">
              ...
              <ul>
                ...
                <li><a href="javascript:void(0)" routerLink="/uuid-generator">UUID Generator</a></li>
                <li><a href="javascript:void(0)" routerLink="/split-expense">Split Expense</a></li>
              </ul>
            </div>
            <div class="footer-column">
              <h4>💰 Finance</h4>
              <ul>
                ...
                <li><a href="javascript:void(0)" routerLink="/loan-timeline" class="highlight-link">Loan Timeline Hacker ✨</a></li>
              </ul>
            </div>
            <div class="footer-column">
              <h4>🔗 Platform</h4>
  ...
  styles: [`
    ...
    /* Highlight badge for newly added features */
    .highlight-link {
    ...
    @media (max-width: 480px) {
      .footer-links { grid-template-columns: repeat(2, 1fr); gap: 20px 12px; }
      .footer-column h4 { font-size: 0.72rem; }
      .footer-column li { font-size: 0.82rem; }
